...
Empirical research that calibrated the **`multi-agent`** skills (`clink-subagents`, `clink-brainstorm`)
and the `qwen-agent` delegation guidance. One dated file per topic.
