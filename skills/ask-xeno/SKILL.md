...
| **Running as Qwen3.8-27B** — the session's model is the local Qwen, through Claude Code | **`using-qwen38`** — the map from task to skill to gate (`qwen38-think` first, then `design-ship-gate` or `qwen38-code-gate`), and the four rules that model needs written down |
