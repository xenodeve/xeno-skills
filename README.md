...
- **[using-qwen38](./skills/qwen38/using-qwen38/SKILL.md)** — router ที่ model โหลดตอนเริ่ม session: งานแบบไหน → โหลด skill ไหน → จบด้วย gate ไหน พร้อมกฎสี่ข้อ (เขียนตาราง brief ก่อน, รันแล้วแปะ output, ห้าม install/หา tool/เปิด agent, หยุดที่รายงาน)
